    ...
    <div className="min-h-screen">
      ...
      <section className="bg-secondary/50 py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-4">All Recipes</h1>
      ...
      <section className="container mx-auto px-4 pb-20">
        {filtered.length > 0 ? (
          ...
          <p className="text-center text-muted-foreground py-20">No recipes found. Try a different search.</p>
        )}
      </section>
    </div>
  );
